...
export const PATHWAYS: PathwayContent[] = [
  ...
  },
  {
    ...
    categories: [
      { slug: "social-clubs", label: "Social Clubs", note: "Regular groups and hosted gatherings for singles." },
      { slug: "dance-classes", label: "Dance Classes", note: "Learn, move and meet people in a relaxed class setting." },
      { slug: "dance-party-clubs", label: "Dance Party Clubs", note: "Music, movement and social nights with energy." },
