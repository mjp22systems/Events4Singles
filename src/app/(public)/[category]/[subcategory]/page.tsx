...
export default async function CategoryCityPage({ params }: Props) {
  ...
  if (childMeta) {
    ...
    const childImage = childHeroImage ?? childMeta.hero_image_url ?? childCardImage ?? `/images/site/category-heroes/category-hero-${childUrlSlug}.svg`;
        ...
        beforeHero={(
          <>
            ...
            <MobileSidePager
              ...
              previous={mobilePreviousStyle ? { href: stylePathFor(mobilePreviousStyle.slug), label: categoryChildLabelForDisplay(categoryDbSlug, mobilePreviousStyle.label) } : null}
              next={mobileNextStyle ? { href: stylePathFor(mobileNextStyle.slug), label: categoryChildLabelForDisplay(categoryDbSlug, mobileNextStyle.label) } : null}
            />
            <nav
  ...
  const categoryImage = categoryHeroImage ?? catMeta.hero_image_url ?? categoryCardImage ?? `/images/site/category-heroes/category-hero-${category}.svg`;
